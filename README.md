...
本fork版本目前由 [@raptorz](https://github.com/raptorz) 维护，主要使用vibe coding进行bug修复，暂不考虑新增功能。

因为不是官方版本，所以仅在本项目的[Release](https://github.com/raptorz/Twidere-Android/releases)页发布更新，无法更新Google Play版本，并且因为没有官方签名，所以也不能直接替换已安装的Google Play版本，需要卸载后安装本版本。
